angular.module('starter.profileOrg', ['ionic', 'ionic-timepicker']).run(['$anchorScroll', function($anchorScroll) {
  $anchorScroll.yOffset = 50;   // always scroll by 50 extra pixels
}])
  .controller('ProfileCtrl', function ($scope, $rootScope, $location, $stateParams, $state, $ionicHistory, $ionicNavBarDelegate, $ionicModal, APIService, ATTACH_PATH, IMAGE_PATH, $timeout, $ionicActionSheet, $location, $anchorScroll, $ionicSideMenuDelegate, Upload, BASE_URL) {
