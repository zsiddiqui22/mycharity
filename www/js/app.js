...
angular.module('starter', ['ionic', 'starter.controllers','angular-clipboard','ngAnimate','ionic-toast',
'ngSanitize', 'starter.projectProfileOrg','starter.discoverMap', 'starter.heroProfile', 'starter.challangeProfile', 'starter.profileOrg', 'starter.services', 'ngCordova', 'rzModule', 'angularPayments', 'ionic-datepicker','ngFileUpload','ngTextTruncate','ionic-timepicker'])

  .run(function ($rootScope, $ionicPlatform, $window, $state) {
    ...
    $rootScope.$on('$stateChangeStart',
      function (event, toState, toParams, fromState, fromParams, options) {
        ...
        if (window.localStorage.getItem('mch_mob_data')) {
          let role_name = JSON.parse(window.localStorage.mch_mob_data).role;

          if ((role_name == "guest") && (
              toState.name == 'app.organzationcreate' ||
              toState.name == 'app.organzationcedit' ||
              toState.name == 'app.challangecreate' ||
              toState.name == 'app.challangeedit' ||
              toState.name == 'app.projectcreate' ||
              toState.name == 'app.projectedit' ||
              toState.name == 'app.herocreate' ||
              toState.name == 'app.heroedit'
            )) {
            if (fromState.name) {
